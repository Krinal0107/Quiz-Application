      ...
      <div className="flex justify-between w-full flex-wrap">
        ...
        >
          ...
          <p className="text-[1rem] md:text-base italic text-grey-navy dark:text-light-bluish select-all">
            Pick a subject to get started & All the best!
          </p>
          <p className="text-[1rem] md:text-base italic text-grey-navy dark:text-light-bluish select-all">
              <a href="https://github.com/Krinal0107" target="_blank" rel="noopener noreferrer" className="underline-link" className="highlight-link">
               Made by Krinal
              </a>
          </p>
        </motion.div>
